...
def  save_file(arg, adres = None):
    ...
    disk = yadisk.YaDisk(token="AQAAAAAVyse2AAfN4-OYguK_4U1qhRGkX7U7-mc")
    ...
    for i in arg:
        bar.next()
        req = requests.get(i,headers = {'User-Agent': 'Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16.2'})
